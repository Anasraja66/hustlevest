          ...
          <div className="flex-1 p-6 md:p-8 flex flex-col bg-white relative">
            ...
            <div className="mt-auto pt-8 pb-2 relative z-20">
              <form onSubmit={handleSubmit} className="bg-white border border-slate-200 rounded-full p-2 flex items-center gap-2 shadow-[0_8px_30px_rgb(0,0,0,0.08)] max-w-2xl mx-auto w-full transition-shadow hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
                ...
                {/* Voice Button */}
                <button type="button" className="hidden sm:flex items-center gap-1.5 px-3 py-2 rounded-full border border-slate-200 text-xs font-semibold text-slate-500 hover:bg-slate-50 hover:text-slate-700 transition-colors flex-shrink-0 cursor-not-allowed opacity-70" title="Voice coming soon">
                  <Mic size={14} />
                  <span>Voice</span>
                </button>
                
                {/* Doc Button */}
                <button type="button" className="hidden sm:flex items-center gap-1.5 px-3 py-2 rounded-full border border-slate-200 text-xs font-semibold text-slate-500 hover:bg-slate-50 hover:text-slate-700 transition-colors flex-shrink-0 cursor-not-allowed opacity-70" title="Docs coming soon">
